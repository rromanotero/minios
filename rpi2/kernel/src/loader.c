...
uint32_t loader_load_app( uint8_t* app_name, tMemRegion* p_mem_region, uint32_t* p_stack_sz  ){
	...
	//         I    M    P    O    R    T     A    N    T
	// ========================================================
	//N O T E:  GOD DAMN FILE READ IS NOT WORKING!!!
	//					NOW I HAVE OT FREAKING HARD CODE IT!
	//					THISIS GOING TO BE A SWEET BUG LATER
	//
	bytes_read = SYS_LOADER_BUFFER_MAX_SIZE;
	...
	load_app( app_memreg.base, (uint8_t*)app_buffer, bytes_read );
